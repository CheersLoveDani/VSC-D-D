...
// Removed fs and path imports for web compatibility
...
export class CompendiumService {
    ...
    public async importXmlCompendium(fileUri: vscode.Uri): Promise<{ spells: number; monsters: number; items: number }> {
